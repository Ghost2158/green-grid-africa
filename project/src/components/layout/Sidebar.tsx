...
const navigation = [
  ...
  { id: 'profile', name: 'Profile Settings', icon: User, roles: ['user', 'operator', 'admin'] },
];
        ...
        <nav className="flex-1 px-4 py-6 space-y-2">
          {availableNavigation.map((item) => (
            <button
              ...
              className={clsx(
                'w-full flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 text-left hover:shadow-sm',
                activeTab === item.id
                  ? 'bg-gradient-to-r from-green-50 to-emerald-50 text-green-700 border-r-2 border-green-500 shadow-sm'
