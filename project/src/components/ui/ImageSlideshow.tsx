...
const africanSolarImages = [
  {
    ...
    caption: 'Solar technician installing solar panel',
    title: 'Sustainable Infrastructure'
  },
  {
    url: '/assets/pexels-gunas4life-19205947.jpg',
    caption: 'Striking fashion portrait with yellow accents',
    title: 'Technical Excellence'
  },
  {
    url: '/assets/pexels-kelly-1179532-4320473.jpg',
    caption: 'African family benefiting from clean solar energy',
    title: 'Energy Access for All'
  },
  {
    url: '/assets/pexels-okiki-onipede-1803710719-29387385.jpg',
    caption: 'Solar installation team working on rooftop systems',
    title: 'Building the Future'
  },
  {
    url: '/assets/pexels-pixabay-371917.jpg',
    caption: 'Community solar project bringing electricity to rural village',
    title: 'Rural Electrification'
  },
  {
    url: '/assets/pexels-wo-nfoni-media-311038690-13998756.jpg',
    caption: 'African woman engineer inspecting solar panels',
